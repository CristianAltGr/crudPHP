...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-05-2023 a las 19:28:43
...
INSERT INTO `producte` (`id`, `nom`, `descripcio`, `preu`, `foto`, `stock`, `menu`, `mides`) VALUES
(1, 'kebab de pollo', 'Tiernos trozos de pollo marinados con una mezcla de especias cuidadosamente seleccionadas, que se asan en un pincho vertical y se cortan en finas y deliciosas tiras. Servido en un pan de pita suave y fresco, nuestro kebab de pollo se complementa con crujiente lechuga, tomate fresco, cebolla y una variedad de salsas para elegir, desde nuestra suave y cremosa salsa blanca hasta nuestra picante y sabrosa salsa de chile. Además, puedes acompañarlo con patatas fritas para hacer de tu experiencia gastronómica un verdadero placer. ¡Ven y prueba nuestro delicioso kebab de pollo en nuestro restaurante hoy mismo!', '5.00', 'https://i.blogs.es/f03b7f/shawarma/450_1000.jpg', 1, 1, 'L'),
