...
<div class="text-left">
    <form>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" readonly class="form-control-plaintext" id="Nom"
                    value="<?php echo $users[0]['nom']; ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="Data_naixement" class="col-sm-2 col-form-label font-weight-bold">Rol</label>
            <div class="col-sm-10">
                <input type="text" readonly class="form-control-plaintext" id="Data_naixement"
                    value="<?php echo $users[0]['rol']; ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" readonly class="form-control-plaintext" id="ensenyament"
                    value="<?php echo $users[0]['usuari']; ?>">
            </div>
        </div>
    </form>
